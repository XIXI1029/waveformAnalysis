...
from .modules.MobileViTV3 import MobileViTBv3
from .modules.ShuffleNetV2 import shufflenetv2
from .modules.GhostNet import Ghostnetv2
from .modules.ELAN import *
from ultralytics.nn.modules.goldyolo import IFM,SimFusion_3in,SimFusion_4in,InjectionMultiSum_Auto_pool,PyramidPoolAgg,TopBasicLayer,AdvPoolFusion
from .modules.MLCA import MLCA, C2f_MLCA
from .modules.Biformer import BiLevelRoutingAttention as Biformer
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in {
            ...
            # else:
            args = [c1, c2, *args[1:]]
            if m in (BottleneckCSP, C1, C2, C2f, C2fAttn, C3, C3TR, C3Ghost, C3x, RepC3, C2f_MLCA, RepNCSPELAN4, RepNCSPELAN4_high):
        ...
        #     args = [ch[f], *args]
            ...
            c2 = m.width_list
            backbone = True
        elif m in {MobileNetV3, shufflenetv2}:
            m = m(*args)
